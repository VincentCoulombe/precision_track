    ...
    if args.optimize_hyperparams:
        ...
        if mot_dataset_ok:
            ...
            search_results = ThresholdsGridSearch(
                ...
                output_path=os.path.join(training_config.work_dir, "tracking_predictions.csv"),
                save_path=os.path.join(training_config.work_dir, "thresholds_grid_search_results.csv"),
            ...
            if "stitching_algorithm" in tracking_config:
                search_results = StitchingHyperparamsGridSearch(
                    ...
                    gt_paths=gt_paths,
                    metadata_path=deploy_cfg.metainfo,
                    bboxes_path=os.path.join(training_config.work_dir, "tracking_predictions.csv"),
                    search_zones_path=os.path.join(training_config.work_dir, "search_zones.csv"),
                    save_path=os.path.join(training_config.work_dir, "stitching_hyperparameter_search.csv"),
