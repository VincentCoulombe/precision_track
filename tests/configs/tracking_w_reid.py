...
validation_configuration_file = "./tests/configs/appearance.yaml"
...
detector = dict(
    runtime=dict(
        model=_base_.model,
        checkpoint="./tests/configs/model_stripedmice_DEPLOYED.onnx",
...
outputs = [
    dict(
        type="CsvCorrections",
        path="./tests/work_dir/tracked_corrections.csv",
