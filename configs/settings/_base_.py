...
default_hooks = dict(
    ...
    checkpoint=dict(interval=-1, type="CheckpointHook", save_best="val/loss", rule="less", priority="NORMAL"),
    colab_download=dict(type="ColabCheckpointHook", priority="BELOW_NORMAL"),
