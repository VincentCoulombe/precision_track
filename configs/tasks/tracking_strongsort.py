...
assigner = dict(
    tracking_algorithm=dict(
        ...
        re_identificator=dict(
            ...
            metainfo="../../../Documents/precision_track-ReID/work_dir/training_runs/mice_mot/re-identification_metadata.yaml",
            checkpoint="../../../Documents/precision_track-ReID/work_dir/training_runs/mice_mot/precision_track_re-identificator.onnx",
        ),
