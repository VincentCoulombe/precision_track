...
from .rewriter_utils import Checker, ContextCaller, RewriterRegistry, copy_function, eval_with_import, get_frame_func, get_func_qualname
...
class SymbolicRewriter:
    ...
    def register_symbolic(
        ...
        **kwargs,
        ...
        """
        return self._registry.register_object(func_name, backend, ir, extra_checkers, is_pytorch=is_pytorch, arg_descriptors=arg_descriptors, **kwargs)
    ...
    def get_context(self, key: Optional[str] = None) -> ContextCaller:
        ...
        if ctx is None:
            MMLogger.get_current_instance().warning(f"Can not found context of {key}")
        return ctx
