...
class BackendChecker(Checker):
    ...
    def __init__(self, required_backend):
        super().__init__()
...
class IRChecker(Checker):
    ...
    Args:
        required_ir (str): The rewriter will be activated on which IR.
    """

    def __init__(self, required_ir: str):
        super().__init__()
...
class RewriterRegistry:
            ...
            for record in rewriter_records:
                ...
                if len(checkers) == 0:
                    ...
                    if default_rewriter is None:
                        ...
                        warnings.warn("Detect multiple valid rewriters for " f"{origin_function}, use the first rewriter.")
                else:
    ...
    def _register(self, name: str, backend, ir: str, extra_checkers: List[Checker], **kwargs):
    ...
    def register_object(self, name: str, backend: str, ir: str, extra_checkers: Optional[Union[Checker, List[Checker]]] = None, **kwargs) -> Callable:
