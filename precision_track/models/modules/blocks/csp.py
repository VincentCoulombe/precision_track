...
class ChannelAttention(BaseModule):
    ...
    def __init__(self, channels: int, init_cfg: Config = None) -> None:
...
class CSPNeXtBlock(BaseModule):
    ...
    def __init__(
        ...
        self.conv2 = DepthwiseSeparableConvModule(
            hidden_channels, out_channels, kernel_size, stride=1, padding=kernel_size // 2, conv_cfg=conv_cfg, norm_cfg=norm_cfg, act_cfg=act_cfg
        )
        self.add_identity = add_identity and in_channels == out_channels
